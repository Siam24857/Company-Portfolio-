...
const footerLinks = {
  services: ['Web Development', 'Full-Stack Development', 'AI & Automation', 'Mobile Development', 'Cloud & Infrastructure', 'UI/UX Design'],
  company: ['About IDEONS', 'Our Projects', 'Technologies', 'Team', 'Contact'],
}
      ...
      <div className="max-w-[1320px] mx-auto px-6 sm:px-10 lg:px-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="font-inter text-sm text-[rgba(248,250,252,0.30)] mb-4">
              Engineering Digital Ideas Into Reality.
            </p>
            <p className="font-inter text-xs text-[rgba(248,250,252,0.25)] mb-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="mailto:siamtechofficial1597@gmail.com" className="font-inter text-sm text-[rgba(248,250,252,0.40)] hover:text-ideon-white transition-colors duration-200">
        ...
        <div className="border-t border-[rgba(248,250,252,0.06)] pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="font-mono text-xs text-[rgba(248,250,252,0.20)]">
            © 2025 IDEONS. All rights reserved.
          </p>
          <div className="flex items-center gap-4">
